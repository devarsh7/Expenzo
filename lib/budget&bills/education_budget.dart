...
class _EducationPageState extends State<EducationPage> with SingleTickerProviderStateMixin {
  ...
  final List<String> _educationOptions = [
    'Tuition', 'Certifications', "Kid's School", 'Others'
  ];
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children: _educationOptions
                            ...
                            .map((entry) => ElevatedButton(
                                  ...
                                  onPressed: () => setState(() => _selectedEducationOption = entry.value),
                                  style: ElevatedButton.styleFrom(
                                    primary: _selectedEducationOption == entry.value
                                        ? Color(0xFF5C6BC0)
                                        : Colors.grey[300],
                                    onPrimary: _selectedEducationOption == entry.value
                                        ? Colors.white
                                        : Colors.black87,
                      ...
                      SizedBox(height: 25),
                      if (_selectedEducationOption.isNotEmpty) ...[
                        TextFormField(
                        ...
                        children: [
                          ElevatedButton.icon(
                            ...
                            onPressed: _isLoading
                                ? null
                                : () async {
                                    if (_selectedEducationOption.isNotEmpty && _amount > 0) {
                                      setState(() {
                                        _isLoading = true;
                                      });
                                      try {
                                        ...
                                        if (userId != null) {
                                          await _budgetService.checkAndInitializeEducationDocument(userId);
                                          await _budgetService.addEducationEntry(
                                              userId, _selectedEducationOption, _amount, _frequency, _selectedDate);
                                          ...
                                          Navigator.push(
                                              context, MaterialPageRoute(builder: (context) => BudgetEntryPage()));
                                        } else {
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        SnackBar(
                                          content: Text('Please select an education option and enter an amount'),
