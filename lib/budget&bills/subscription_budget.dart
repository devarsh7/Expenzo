                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children: _subscriptionOptions
                            .map((subscription) => ElevatedButton(
                                  child: Text(subscription),
                                  onPressed: () => setState(() => _selectedSubscription = subscription),
                                  style: ElevatedButton.styleFrom(
                                    primary: _selectedSubscription == subscription
                                        ? Color(0xFF5C6BC0)
                                        : Colors.grey[300],
                                    onPrimary: _selectedSubscription == subscription
                                        ? Colors.white
                                        : Colors.black87,
                            ...
                            onPressed: _isLoading
                                ...
                                : () async {
                                    if (_selectedSubscription.isNotEmpty && _amount > 0) {
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        SnackBar(content: Text('Please select a subscription and enter an amount')),
                                      );
                                    }
                                  },
                            style: ElevatedButton.styleFrom(
