...
import 'package:expenzo/budget&bills/kids_budget.dart';
                      ...
                      Wrap(
                        ...
                        children: _educationOptions
                            .map((option) => ElevatedButton(
                                  child: Text(option),
                                  onPressed: () => setState(() => _selectedEducationOption = option),
                                  style: ElevatedButton.styleFrom(
                                    primary: _selectedEducationOption == option
                                        ? Color(0xFF5C6BC0)
                                        : Colors.grey[300],
                                    onPrimary: _selectedEducationOption == option
                                        ? Colors.white
                                        : Colors.black87,
                                      ...
                                      try {
                                        ...
                                        if (userId != null) {
                                          ...
                                          ScaffoldMessenger.of(context).showSnackBar(
                                            SnackBar(content: Text('Education entry added successfully')),
                                          );
                                          Navigator.push(
                                              context,
